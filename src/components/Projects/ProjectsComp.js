...
import P5 from "../../images/P5_image.png"

const projects = [
  {
    id: 1,
    title: "Spruce Technology",
    description:
      "This project was built using ReactJS, PHP, HTML and CSS on Visual Studio Code",
    image: P5,
  },
  {
    id: 2,
          ...
          {projects.map(item => (
            <Grid item key={item.id} xs={12} sm={6} md={4}>
              <Card sx={{ maxWidth: 345 }} className="p_card">
                ...
                ></StaticImage> */}
                <img className="project_image" src={item.image} alt=""></img>
